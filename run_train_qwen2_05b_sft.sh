...
#training
LOG_ARGS="--log_interval 1 --save_interval 500 --eval_interval 100 --eval_iters 10"

TRAIN_ARGS="--train_iters 5000 --lr_decay_style constant --weight_decay 0.1 
--lr_warmup_iters 100 --lr 1e-5 --min_lr 5e-6 
...
MEGATRON_Trains=(
	1 ${current_directory}/dataset/sample_sft_preprocessed_data/train
)
...
torchrun $DISTRIBUTED_ARGS finetune.py \
	...
	--save ${current_directory}/model/qwen2/qwen2_05b_megatron_t2p1_sft  \
	--tensorboard_dir ${current_directory}/model/qwen2/qwen2_05b_megatron_t2p1_sft/logs/ \
	--model_name qwen \
